/*! elementor - v2.5.12 - 08-04-2019 */ ! function (e) {
    ...
    184: function (e, t, n) {
        ...
        var i = elementorModules.frontend.handlers.Base.extend({
                ...
                deactivate: function () {
                    this.isYTVideo && this.player.getIframe() ? this.player.destroy() : this.elements.$backgroundVideoHosted.removeAttr("src"), elementorFrontend.elements.$window.off("resize", self.changeVideoSize)
                },
                run: function () {
